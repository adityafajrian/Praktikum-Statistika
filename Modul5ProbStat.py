...
print("Probabolitas tinggi kurang dari 189 cm:", prob_less_than_189)
...
print("Probabolitas tinggi antara 174 cm dan 199 cm:", prob_between_174_and_199)
...
print("Rata-rata jumlah pelanggan dalam sistem (L) setelah perubahan: {:.2f}".format(W_new))
